...
customerNames = ['Madhu', 'albu', 'tom', 'John', 'Jack']
customerPins = ['1234', '', '2000', '1234', '5049']
...
while True:
    # os.system("cls")
    print("_____WELCOM TO BANK OF INDIA________ ")
    ...
    selectNumber = input("Select your number from the above menu : ")
    if selectNumber == "1":
